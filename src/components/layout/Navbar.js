  ...
  return (
    <nav
      className={cn(
        ...
        scrolled || isOpen
          ? "translate-y-0 bg-background/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 py-2"
          : "-translate-y-full py-4 pointer-events-none opacity-0"
      )}
    >
      <Container>
